...
for CONFIG_FILE_NAME in predict_clotho_beam_classic3_config \
                        predict_clotho_beam_classic5_config \
                        predict_clotho_beam_classic8_config \
                        predict_clotho_beam_classic10_config \
                        predict_clotho_beam_classic12_config \
                        predict_clotho_beam_classic15_config 
do

    echo "Running inference with config file: ${CONFIG_FILE_NAME}.yaml"
    DATASET=clotho_v2.1_backup # clotho_v2.1
    RUN_NAME=magic-mountain-74 # rose-lake-75 # atomic-sky-43 # magic-mountain-74 # efficient-jazz-72 # dainty-yogurt-57 # mythical-trooper-62 (lora?)
    CHECKPOINT=5000 # 1000 # 13500 # 6200  # 1000 # 2600
    SPLIT=validation
