...
do
    ...
    RUN_NAME=stilted-vortex-116 # peach-bush-111 # stilted-vortex-116 # trim-snow-114 # rose-lake-75 # atomic-sky-43 # magic-mountain-74 # efficient-jazz-72 # dainty-yogurt-57 # mythical-trooper-62 (lora?)
    CHECKPOINT=1500 # 10500 # 1500 # 2200 # 2000 # 1000 # 13500 # 6200  # 1000 # 2600
    SPLIT=validation
